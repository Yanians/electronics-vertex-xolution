...
render(){
   ...
   return(
	   	  <Devices details={wait} viewItem={this.viewItems} clickAddToCart={this.clickPurchase} removeClass={this.remove} showClass={this.add} index={this.state.indexes} data={this.state.returnersdata} />                 
       ); 
   }
}
