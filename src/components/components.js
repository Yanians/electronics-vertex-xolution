...
export default class Services extends React.Component{
  ...
  class DeviceItem extends Component{
    ...
    render(){
     const {title, viewItem, desc,price,src,children,referenceId,addToCart, idValue} = this.props
     return( 
                       ...
                       <Row>
                         <Cols s12>
                            <Cols s6 style={{height:'50px',lineHeight:'50px',padding:'0 0 0 16px'}} className="book-me" >
                              <button value={referenceId} onClick={null} className="red-text book-me-edited">Book</button>
                            </Cols>
...
export class View extends Component{render(){
  ...
  render(){
    const { viewItem, clickAddToCart, details } = this.props
